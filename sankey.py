...
color_dict_link = ['rgba(252,65,94,0.4)', 'rgba(255,162,0,0.4)', 'rgba(55,178,255,0.4)', 'rgba(255,162,0,0.4)', 'rgba(252,65,94,0.4)', 'rgba(66, 95, 252, 0.4)', 'rgba(55,178,255,0.4)',
                   'rgba(43, 215, 116, 0.4)', 'rgba(66, 95, 252, 0.4)', 'rgba(243, 93, 6, 0.4)', 'rgba(0, 36, 165, 0.4)', 'rgba(66, 95, 252, 0.4)', 'rgba(43, 215, 116, 0.4)',
                   'rgba(255,162,0,0.4)', 'rgba(243, 93, 6, 0.4)', 'rgba(0, 36, 165, 0.4)', 'rgba(141, 53, 131, 0.4)', 'rgba(243, 93, 6, 0.4)', 'rgba(141, 53, 131, 0.4)',
                   'rgba(0, 36, 165, 0.4)', 'rgba(141, 53, 131, 0.4)', 'rgba(252,65,94,0.4)', 'rgba(252,65,94,0.4)', 'rgba(43, 215, 116, 0.4)', 'rgba(66, 95, 252, 0.4)',
                   'rgba(243, 93, 6, 0.4)', 'rgba(0, 36, 165, 0.4)', 'rgba(141, 53, 131, 0.4)', 'rgba(255,162,0,0.4)', 'rgba(55,178,255,0.4)', 'rgba(43, 215, 116, 0.4)',
                   'rgba(0, 36, 165, 0.4)', 'rgba(141, 53, 131, 0.4)', 'rgba(243, 93, 6, 0.4)', 'rgba(255,162,0,0.4)', 'rgba(141, 53, 131, 0.4)']
